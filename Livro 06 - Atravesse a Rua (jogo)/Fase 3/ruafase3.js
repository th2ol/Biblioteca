...
const p1 = [{x: 0, y: 90}, {x: 30, y: 90}, {x: 60, y: 90 }, {x: 90, y: 90}, {x: 120, y: 90}, {x: 150, y: 90}, {x: 180, y: 90}, {x: 210, y: 90}, {x: 240, y: 90}]
const p2 = [{x: 120, y: 150}, {x: 150, y: 150}, {x: 180, y: 150}]
const p3 = [{x: 240, y: 210}, {x: 270, y: 210}, {x: 300, y: 210}]
const p4 = [{x: 90, y: 270}, {x: 120, y: 270}, {x: 150, y: 270}]
const p5 = [{x: 0, y: 330}, {x: 30, y: 330}, {x: 60, y: 330}]
const p6 = [{x: 180, y: 390}, {x: 210, y: 390}, {x: 240, y: 390}]
const p7 = [{x: 450, y: 450}, {x: 480, y: 450}, {x: 510, y: 450}]
...
const checkcolision = () => {
    ...
    const colision1 = parede1.find((position) => {
        return position.x == head.x && position.y == head.y

    })
    const colision2 = parede2.find((position) => {
        return position.x == head.x && position.y == head.y
...
buttonplay.addEventListener("click", () => {
    ...
    parede1 = [{x: 0, y: 90}, {x: 30, y: 90}, {x: 60, y: 90 }, {x: 90, y: 90}, {x: 120, y: 90}, {x: 150, y: 90}, {x: 180, y: 90}, {x: 210, y: 90}, {x: 240, y: 90}]
    parede2 = [p2]
    parede3 = [p3]
    parede4 = [p4]
    parede5 = [p5]
